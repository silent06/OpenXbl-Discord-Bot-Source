            ...
            <?php 
              ...
              if(isset($achievements)) 
              {
                  if(!empty($json3['titles']))
                  {
                      ...
                      {
                          $output1 .= "<table>";
                          //$output1 .= "  <li><b style=color:red;><u> " .$people['name'].  " <span href= '".$people['displayImage']." '> <img src= '".$people['displayImage']."'  width=100 height=100 border=25 ></span></b></u></li>  " ;
                          $output1 .= "<li><a><span href= '".$people['displayImage']." '> <img src= '".$people['displayImage']."' width=100 height=100 border=0 />  </span></a></li> ";
