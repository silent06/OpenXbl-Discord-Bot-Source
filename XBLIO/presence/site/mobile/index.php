...
<body>
<div id="container">
<div id="header"><h1><a>presenceList List:</a></h1></div>
      ...
      <p><li><strong> <?php 
        ...
        if(isset($presenceList)) 
        {
          foreach ($json as $people) {
            $output1 .= " <dt><b><u> Xuid: </b></u>"  .$people['xuid']. "</dt> ";
            $output1 .= " <dt><b><u> State: </b></u>"  .$people['state']. "</dt> ";
            $output1 .= " <dt><b><u> Last Device Played?: </b></u> "  .$people['lastSeen']['deviceType']. "</dt> ";
            $output1 .= "<dt><b><u> Title Id: </b></u> "  .$people['lastSeen']['titleId']. "</dt> ";
            $output1 .= " <dt><b><u> Last Game Played: </b></u>"  .$people['lastSeen']['titleName']. "</dt> ";
            $output1 .= " <dt><b><u> Player Timestamp: </b></u>"  .$people['lastSeen']['timestamp']. "\n</dt> ";
